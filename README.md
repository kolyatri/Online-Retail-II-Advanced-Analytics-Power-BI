...
The analysis is based on **transactional invoice-line data**, including:
- orders and products
...
- Customer loyalty is strong (~72% repeat customers), but revenue is highly concentrated
- Returns are infrequent and declining in impact, but still result in measurable revenue loss
